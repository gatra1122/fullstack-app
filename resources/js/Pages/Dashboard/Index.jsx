    ...
    return (
        <>
            ...
            <Layout>
                ...
                <Card className="mt-6 w-full animate-fade animate-once animate-duration-200">
                    <CardHeader color="blue-gray" className="relative h-[600px]">
                        <img
                    ...
                    <CardBody>
                    <Typography className='p-2 text-lg mb-8'>
